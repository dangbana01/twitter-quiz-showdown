  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        sentient: {
          pink: "hsl(var(--sentient-pink))",
          'pink-light': "hsl(var(--sentient-pink-light))",
          'pink-dark': "hsl(var(--sentient-pink-dark))",
          coral: "hsl(var(--sentient-coral))",
        },
        tech: {
